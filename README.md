...
웹캠을 연결하여 주차 차량의 사진을 캡처하고 이를 번호판 인식에 활용하였으며 주차 차량의 모습을 확인할 수 있도록 비디오 파일로 저장하여 관리자 프로그램에서 확인할 수 있도록 하였음. 또한 MJPG-Streamer를 사용하여 주차장 전체 모습을 스트리밍으로 확인할 수 있도록 하였음.<p><p>
